...
APP_SPECIFIC_STRINGS: dict[str, str] = {
    ...
    # Overwrite modes (app display names differ slightly from upstream)
    "app.extract.ask": "Ask",
    "app.extract.overwrite": "Overwrite",
    "app.extract.skipExisting": "Skip Existing",
    "app.extract.rename": "Rename",
    "app.extract.renameExisting": "Rename Existing",
    ...
    "app.settings.languageChanged": "Language Changed",
    "app.settings.languageChangedMessage": "Please restart the application for the language change to take full effect.",
